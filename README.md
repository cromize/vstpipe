...
Audio is sent as 32-bit interleaved stereo. You can play pipe output using included server.py. Buffer size is set automatically. Older version using Windows namedpipe is in branch namedpipe.
